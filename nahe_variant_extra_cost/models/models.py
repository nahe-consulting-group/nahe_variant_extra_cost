...
class productproductextra(models.Model):
    _inherit = "product.product"

    standard_price_extra = fields.Float(
        'Costo Extra Variante', default=0, digits='Product Price',
        help='Costo Extra para esta Variante a ser utilizada en las listas de precios basada en costo')

class Pricelist(models.Model):
    _inherit = "product.pricelist"
    
    # heredamos la funcion completa de _compute_price_rule desde addons/product/product_pricelist.py para pisarla y editar la formula
            ...
            for rule in items:
                ...
                if rule.base == 'pricelist' and rule.base_pricelist_id:
                    ...
                    if rule.base == 'standard_price':
                        if product.standard_price_extra:
                            price= price + product.standard_price_extra
